...
var DEBUG=!1;!function(o){"use strict";var e,n;"undefined"!=typeof wpbo?(e=wpbo.replace(/&quot;/g,'"'),n=o.parseJSON(e),DEBUG&&console.log(n)):n={close_overlay:!0,close_esc:!0,cookie_lifetime:"30",animation:"bounceIn",popup_id:"betterOpt",overlayOpacity:.5,overlayColor:"#000"},o(function(){var e="wpbo_"+n.popup_id,t=o(".wpbo-modal").hide(),a=t.parent(".optform");t.easyModal({top:200,overlayOpacity:n.overlay_opacity,overlayColor:n.overlay_color,overlayClose:n.close_overlay,transitionIn:"animated "+n.animation,updateZIndexOnOpen:!1,closeOnEscape:n.close_esc,closeButtonClass:".wpbo-close",onClose:function(){var t=new Date;t=t.toDateString(),t=t.split(" ").join("_"),o.cookie(e,"closed_on_"+t,{expires:n.cookie_lifetime,path:"/"})},onOpen:function(){var e={action:"wpbo_new_impression",popup_id:n.popup_id};o.post(n.ajaxurl,e),jQuery().matchHeight&&o(".wpbo-col").matchHeight(".wpbo-grid-no-gutter"),a.find("input:first").focus(),a.submit(function(){a.find("[type=submit]").prop("disabled",!0).text("Please wait...")})}}),null==o.cookie(e)&&o(document).one("mouseleave",function(e){e.preventDefault(),t.trigger("openModal").addClass("wpbo-modal-active"),n.wiggle===!0&&o(document).on("click",'.lean-overlay:not(".wpbo-modal")',function(){t.addClass("wpbo-tada"),t.on("oanimationend animationend webkitAnimationEnd",function(){o(this).removeClass("wpbo-tada")})})}),o(".wpbo-trigger").on("click",function(o){o.preventDefault(),t.trigger("openModal").addClass("wpbo-modal-active")})})}(jQuery);